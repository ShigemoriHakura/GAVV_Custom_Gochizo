        ...
        <div class="table-responsive">
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">225</p>
                        </td>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">12k</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">215</p>
                        </td>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">16k</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">179</p>
                        </td>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">30k</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
